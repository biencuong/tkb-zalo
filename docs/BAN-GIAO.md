...
**Giữ 3 bản phát hành mới nhất** (người dùng yêu cầu 21/9/2026): sau `gh release create` chạy `bash scripts/don-ban-cu.sh` — xoá bản phát hành + tệp cài cũ, **giữ git tag**. Phát hành xong **cài ngay lên máy người dùng**.
