...
contextBridge.exposeInMainWorld("api", {
  ...
  gv: {
    ...
    luu: goi("gv:luu"),
    xoa: goi("gv:xoa"),
    xemTruocExcel: goi("gv:xem-truoc-excel"),
    xoaTatCa: goi("gv:xoa-tat-ca"),
    ...
    datNhanNhanh: goi("gv:dat-nhan-nhanh"),
    datNhanTatCa: goi("gv:dat-nhan-tat-ca"),
  },
  tkb: {
    ds: goi("tkb:ds"),
  ...
  zalo: {
    ...
    lamMoiNhom: goi("zalo:lam-moi-nhom"),
    onDoi: nghe("zalo:doi"),
